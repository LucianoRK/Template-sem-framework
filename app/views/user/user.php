                ...
                <form action="#" class="form-horizontal">
                    <div class="form-body">
                        <div class="form-group row">
                            ...
                            <div class="col-md-5">
                                <input type="text" placeholder="Your first name" class="form-control" autocomplete="given-name">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="control-label text-right col-md-3">Last Name</label>
                            <div class="col-md-5">
                                <input type="text" placeholder="Your last name" class="form-control" autocomplete="family-name">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="control-label text-right col-md-3">Email Address</label>
                            <div class="col-md-5">
                                <input type="text" placeholder="Your email address" class="form-control" autocomplete="email">
